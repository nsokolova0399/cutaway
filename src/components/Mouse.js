...
function Mouse() {
    function onmousedown(e) {
        ...
        function moveAt(e) {
            ...
            console.log('border x ', border.getBoundingClientRect().x)
            console.log('border with + x  ', border.getBoundingClientRect().x + border.getBoundingClientRect().width / 2)
            console.log(e.pageX)
            console.log(e.pageX - square.offsetWidth / 2)
        ...
        <div className="main-font" style={{backgroundColor: "#adb8ff", color: "black"}}>
            ...
            <div className="main-puzzle">
                <div className="main-block1-square">
                    <img className="item-1" alt="" src="image/rectangle1.svg" onMouseDown={onmousedown} style={{}}/>
                    <img className="item-2" alt="" src="image/rectangle2.svg" onMouseDown={onmousedown} style={{}}/>
                    <img className="item-3" alt="" src="image/rectangle3.svg" onMouseDown={onmousedown} style={{}}/>
                    <img className="item-4" alt="" src="image/rectangle4.svg" onMouseDown={onmousedown} style={{}}/>
                </div>
